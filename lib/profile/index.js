...
function defaults ( ) {
  return /* profile */ {
    ...
    , use_Static_COB_decay: false // Defaults to false. This is to enable constant COB decay with dISF, see lib/determine-basal/cob.js
    , cobDecayAdjust: 1 // Default value: 1. Adjustment factor for carb absorption / COB decay. Higher number = faster absorption (for tuning of constant COB decay with dISF, see lib/determine-basal/cob.js)
  };
}
...
function displayedDefaults () {
    ...
    profile.cobDecayAdjust = allDefaults.cobDecayAdjust;
